...
for i in range(1, number_of_quick_picks + 1):
    quick_picks = []
    for j in range(MIN_RANDOM_NUMBER_COUNT, MAX_RANDOM_NUMBER_COUNT + 1):
        generated_result = random.randint(MIN_RANDOM_NUMBER_RANGE, MAX_RANDOM_NUMBER_RANGE)
